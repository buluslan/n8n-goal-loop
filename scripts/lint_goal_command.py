#!/usr/bin/env python3
"""Lightweight validation for n8n-goal-loop outputs (nine-element n8n /goal)."""
...
REQUIRED_MARKER_GROUPS = [
    ...
    ("data flow", [r"Data Flow[:：]", r"Data flow[:：]", r"数据流[:：]"]),
    ("error handling", [r"Error Handling[:：]", r"Error handling[:：]", r"错误处理[:：]"]),
]
